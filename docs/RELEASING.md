...
The project uses semantic versioning. The first HACS-ready release is
`1.4.0` and the Git tag is `v1.4.0`.
...
```bash
git tag -a v1.4.0 -m "Medication Stock Manager v1.4.0"
git push origin v1.4.0
gh release create v1.4.0 \
  --title "Medication Stock Manager v1.4.0" \
